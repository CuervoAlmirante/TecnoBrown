      ...
      <form onSubmit={onSubmit} className="space-y-4">
        ...
        <div className="grid md:grid-cols-2 gap-3">
          <input
            ...
            placeholder="Nombre (ej. Esclava Mariposa Strass)"
          />
          <input
            name="price"
            value={form.price}
        ...
        <div className="grid md:grid-cols-2 gap-3">
          <input
            ...
            step="0.01"
            className="w-full border p-2 rounded"
            placeholder="Precio original (opcional, ej. 15000)"
          />
          <select
            name="category"
            value={form.category}
          ...
          >
            ...
            <option value="btParlantes">Parlantes Bluetooth</option>
            <option value="accesoriosPc">Accesorios de PC</option>
            <option value="cables">Cables</option>
            <option value="accesoriosCel">Accesorios para celular</option>
          </select>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-3">
          <input
            ...
            onChange={onChange}
            className="w-full border p-2 rounded"
            placeholder="Medida/peso (ej. 10 cm)"
          />
          <input
            name="ingredients"
            ...
            onChange={onChange}
            className="w-full border p-2 rounded"
            placeholder="Materiales (ej. Acero 316L, strass)"
          />
        </div>
        ...
        <button
          className="w-full honey-gradient text-white rounded p-3"
          disabled={saving}
        >
